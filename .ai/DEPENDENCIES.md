...
Python 3.12 runs FastAPI under Uvicorn. Pydantic Settings loads configuration;
SQLAlchemy async and asyncpg access PostgreSQL. PyJWT, Passlib, and Argon2
implement sessions/passwords. Google Auth verifies identity and Pub/Sub OIDC
tokens, cryptography encrypts Play tokens, and boto3 sends SES email.
